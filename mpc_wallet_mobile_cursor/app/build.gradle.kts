...
dependencies {
    ...
    // NOTE: tss-lib is a Go library and will be integrated via gomobile/JNI bridge module.
    // This app module already defines stable interfaces for that runtime integration.
